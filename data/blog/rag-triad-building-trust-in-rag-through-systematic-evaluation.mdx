...
In early 2023, a lawyer submitted a brief to the court citing multiple case precedents—except the cases didn't exist. They were hallucinations, fabricated by ChatGPT with such conviction that even the experienced attorney didn't verify them. The result? Court sanctions and a stark reminder of AI's potential for deception[^1].

This isn't an isolated incident. AI systems have shown an unsettling tendency to make things up. Studies suggest large language models hallucinate in 27% of their responses, with factual errors in nearly half of their outputs[^2].
...
- Detailed metrics for each evaluation pillar
- Performance trends over time
- Individual query analysis
- Failure detection and analysis
- Cost and latency tracking

You can access the dashboard at `http://localhost:8501` in your browser. The interface allows you to:

1. View overall performance metrics
2. Drill down into individual queries
3. Compare different versions of your RAG system
4. Identify patterns in failures or low-scoring responses
5. Track costs and latency trends
...
1. Maruf, R. (2023, May 27)
   [Lawyer apologizes for fake court citations from ChatGPT](https://edition.cnn.com/2023/05/27/business/chat-gpt-avianca-mata-lawyers/index.html)

2. Metz, C. (2023, November 6)
...
3. IBM Technology
   [AI Hallucinations](https://www.ibm.com/think/topics/ai-hallucinations)
...
5. TruLens Documentation
   [RAG Triad Core Concepts](https://www.trulens.org/getting_started/core_concepts/rag_triad/)

6. Huyen, C. (2024)
   [AI Engineering: Building Applications with Foundation Models](https://learning.oreilly.com/library/view/ai-engineering/9781098166298/ch06.html#ch06_rag_architecture_1730157386571677)
...
8. LiteLLM Documentation
   [WatsonX Provider Guide](https://docs.litellm.ai/docs/providers/watsonx)
