...
<Image
  alt="OWASP Figure 3 showing LLM supply-chain attack surfaces across training, model repositories, development, inference, applications, and on-device deployment"
...
<DiagramSubtitle>
  Figure 3: A simple LLM supply-chain threat model illustrating supply-chain attack surfaces.
  Source: [OWASP Top 10 for LLM Applications
  2026](https://genai.owasp.org/download/56857/?tmstv=1785822482), used under CC BY-SA 4.0.
</DiagramSubtitle>
