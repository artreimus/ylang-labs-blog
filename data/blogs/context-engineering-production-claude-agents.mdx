...
draft: false
summary: 'Production agents get cheaper and more reliable when teams treat context as infrastructure, not as an ever-growing prompt.'
tldr: |
...
Brad Abrams' Code w/ Claude 2026 session, ["Getting more out of the Claude Platform"](https://claude.com/code-with-claude/session/sf-getting-more-out-of-the-claude-platform), made that operational side concrete. The pattern is simple: cache what repeats, retrieve what is needed, filter what comes back, compact what gets old, and ask a stronger model only when the decision deserves it.
...
Prompt caching turns that repeated prefix into a cost lever. Anthropic describes it as resuming from specific prompt prefixes to reduce processing time and cost, with cache reads priced at 0.1x the base input-token price for supported models ([Anthropic prompt caching docs](https://platform.claude.com/docs/en/build-with-claude/prompt-caching)).
...
Put these pieces together and you get a practical architecture for production agents:
...
2. Anthropic, ["Caching, harnesses, and advisors: Building on Claude at GitHub scale"](https://claude.com/code-with-claude/session/sf-caching-harnesses-and-advisors-building-on-claude-at-github-scale), Code w/ Claude 2026 San Francisco.
3. Anthropic, ["Prompt caching"](https://platform.claude.com/docs/en/build-with-claude/prompt-caching).
4. Anthropic, ["Tool search tool"](https://platform.claude.com/docs/en/agents-and-tools/tool-use/tool-search-tool).
5. Anthropic, ["Programmatic tool calling"](https://platform.claude.com/docs/en/agents-and-tools/tool-use/programmatic-tool-calling).
6. Anthropic, ["Compaction"](https://platform.claude.com/docs/en/build-with-claude/compaction).
7. Anthropic, ["Advisor tool"](https://platform.claude.com/docs/en/agents-and-tools/tool-use/advisor-tool).
8. GitHub Docs, ["Hosting of models for GitHub Copilot"](https://docs.github.com/en/enterprise-cloud@latest/copilot/reference/ai-models/model-hosting).
9. GitHub Docs, ["Models and pricing for GitHub Copilot"](https://docs.github.com/en/enterprise-cloud@latest/copilot/reference/copilot-billing/models-and-pricing).
