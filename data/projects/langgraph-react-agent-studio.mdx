---
title: 'LangGraph React Agent Studio'
date: '2025-06-12'
tags: ['AI/ML', 'LangGraph', 'React', 'Agents', 'MCP', 'LangChain']
lastmod: '2025-06-12'
draft: false
...
image: '/static/images/projects/langgraph-react-agent-studio/demo.gif'
cardImage: '/static/images/projects/langgraph-react-agent-studio/app-1.png'
authors: ['arthur-reimus']
layout: 'ProjectLayout'
github: 'https://github.com/Ylang-Labs/langgraph-react-agent-studio'
---
...
<Image
  alt="Welcome Screen"
  src="/static/images/projects/langgraph-react-agent-studio/app-1.png"
  width={800}
  height={300}
  className="mx-auto"
/>
<DiagramSubtitle>Figure: Welcome Screen.</DiagramSubtitle>

<Image
  alt="Math Agent Results"
  src="/static/images/projects/langgraph-react-agent-studio/app-2.png"
  width={800}
  height={300}
  className="mx-auto"
/>
<DiagramSubtitle>Figure: Math Agent Results.</DiagramSubtitle>

<Image
  alt="MCP Agent Results"
  src="/static/images/projects/langgraph-react-agent-studio/app-3.png"
  width={800}
  height={300}
  className="mx-auto"
/>
<DiagramSubtitle>Figure: MCP Agent Results.</DiagramSubtitle>

<Image
  alt="Deep Researcher Results"
  src="/static/images/projects/langgraph-react-agent-studio/app-4.png"
  width={800}
  height={300}
  className="mx-auto"
/>
<DiagramSubtitle>Figure: Deep Researcher Results.</DiagramSubtitle>
...
<Image
  ...
  src="/static/images/projects/langgraph-react-agent-studio/architecture.png"
  width={800}
  height={300}
  className="mx-auto"
/>
<DiagramSubtitle>Figure: Architecture Overview.</DiagramSubtitle>
...
This project is licensed under the Apache License 2.0. See the [LICENSE](https://github.com/Ylang-Labs/langgraph-react-agent-studio/blob/main/LICENSE) file for details.
